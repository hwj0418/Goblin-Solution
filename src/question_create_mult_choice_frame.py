...
class MultiChoiceQuestionFrame(tk.Frame):
    ...
    def checkAndDisableAnswer(self):
        '''(MultiChoiceQuestionPage) -> NoneType
    ...
    def toggleInstantFeedback(self, entry, var):
        '''(MultiChoiceQuestionPage, Entry, IntVar) -> NoneType
